...
**PROMPT FOR GENERATING JEE TEST MCQs (PHYSICS, CHEMISTRY, MATHS) -
	...
	>STEP 2 - QUESTION GENERATION RULES:
	    ...
	    - Strictly enforce the difficulty mix (20% easy / 50% moderate / 30% hard) (but keep the difficulty of the ques default increase by 20% ) and the answer-type mix (single-correct / multi-correct / numerical, matching real JEE proportions) across every batch of questions generated - do not default to all single-correct or all similar difficulty.
