...
**PROMPT FOR GENERATING JEE TEST MCQs (PHYSICS, CHEMISTRY, MATHS) -
	...
	>STEP 1 - INTERNAL ANALYSIS (always do this first, silently, before generating any question):
	    ...
	    3. Difficulty Calibration: Assign difficulty as Easy/Moderate/Hard based on actual JEE distribution (roughly 10% easy, 50% moderate, 45% hard per topic) - don't cluster all questions at one difficulty.
	...
	>STEP 2 - QUESTION GENERATION RULES:
	    ...
	    - Strictly enforce the difficulty mix (10% easy / 50% moderate / 40% hard) and the answer-type mix (single-correct / multi-correct / numerical, matching real JEE proportions) across every batch of questions generated - do not default to all single-correct or all similar difficulty.
